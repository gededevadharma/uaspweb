<div class="d-flex justify-content-between align-items-center mb-3">
    <div>
        <a href="<?= base_url('admin/buku/tambah') ?>" class="btn btn-primary"><i class="bi bi-plus-circle"></i> Tambah Buku</a>
    </div>
    <div>
        <form action="<?= base_url('admin/buku') ?>" method="get" class="d-flex">
            <input type="text" name="search" class="form-control search-box me-2" placeholder="Cari buku..." value="<?= $search ?>">
            <button class="btn btn-outline-dark" type="submit"><i class="bi bi-search"></i></button>
            <?php if ($search): ?>
            <a href="<?= base_url('admin/buku') ?>" class="btn btn-outline-danger ms-1"><i class="bi bi-x-circle"></i></a>
            <?php endif; ?>
        </form>
    </div>
</div>
...
<div class="card">
    <div class="card-body">
            ...
            <table class="table table-hover align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?= base_url('admin/buku/detail/' . $b->id) ?>" class="btn btn-info btn-sm"><i class="bi bi-eye"></i></a>
                            <a href="<?= base_url('admin/buku/edit/' . $b->id) ?>" class="btn btn-warning btn-sm"><i class="bi bi-pencil"></i></a>
        ...
        <nav>
            <ul class="pagination justify-content-center">
                ...
                <li class="page-item <?= $i == $page ? 'active' : '' ?>">
                    <a class="page-link" href="<?= base_url('admin/buku?page=' . $i . ($search ? '&search=' . $search : '')) ?>"><?= $i ?></a>
                </li>
                <?php endfor; ?>
            </ul>
        </nav>
        ...
        <div class="text-center py-5">
            ...
            <a href="<?= base_url('admin/buku/tambah') ?>" class="btn btn-primary mt-2">Tambah Buku</a>
        </div>
        <?php endif; ?>
    </div>
</div>
