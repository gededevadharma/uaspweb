    ...
    <div class="col-md-4">
        <div class="card h-100">
            <div class="card-header bg-white d-flex justify-content-between align-items-center">
                ...
                <a href="<?= base_url('peminjaman') ?>" class="btn btn-sm btn-outline-dark">Lihat</a>
            </div>
            <div class="card-body">
    ...
    <div class="col-md-4">
        <div class="card h-100">
            <div class="card-header bg-white d-flex justify-content-between align-items-center">
                ...
                <a href="<?= base_url('buku') ?>" class="btn btn-sm btn-outline-dark">Lihat</a>
            </div>
            <div class="card-body">
                <?php if ($buku_terbaru): ?>
                <table class="table table-sm table-borderless mb-0">
    ...
    <div class="col-md-4">
        <div class="card h-100">
            <div class="card-header bg-white d-flex justify-content-between align-items-center">
                ...
                <a href="<?= base_url('peminjam') ?>" class="btn btn-sm btn-outline-dark">Lihat</a>
            </div>
            <div class="card-body">
